            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container">
                        ...
                        <table class="table" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th><img src="{{ Storage::url($row->file) }}" alt="product image" width="100"></th>
                                    <td class="action-links">
                                        <a href="{{ route('skill.show', $row) }}">Detail</a>
                                        <a href="{{ route('skill.edit', $row) }}">Edit</a>
                        ...
                        <a href="{{ route('skill.create') }}" class="create-btn">Create</a> 
