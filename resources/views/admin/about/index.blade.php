                ...
                <main>
                  <br>
                    <div class="container">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="action-links">
                                        <a href="{{ route('about.show', $row) }}">Detail</a>
                                        <a href="{{ route('about.edit', $row) }}">Edit</a>
                                        <button type="button" class="delete-btn"
                                                                data-id="{{ $row->id }}">Delete</button>
                                                            <form id="delete-form-{{ $row->id }}"
                                                                action="{{ route('about.destroy', $row->id) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
                                    </td>
                        ...
                        <a href="{{ route('about.create') }}" class="create-btn">Create</a> 
