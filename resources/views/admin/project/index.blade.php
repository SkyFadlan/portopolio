                ...
                <main>
                  <br>
                    <div class="container">
                        ...
                        <table class="table" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td></strong> <a href="{{ $row->link }}" target="_blank">{{ $row->link }}</a></td>
                                    <td>{{ $row->date }}</td>
                                    <td class="action-links">
                                        <a href="{{ route('project.show', $row) }}">Detail</a>
                                        <a href="{{ route('project.edit', $row) }}">Edit</a>
                        ...
                        <a href="{{ route('project.create') }}" class="create-btn">Create</a> 
